                  ...
                  <motion.div key={i} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}>
                    <Card className="group hover:shadow-md hover:border-primary/20 transition-all cursor-pointer">
                      <CardContent className="p-4 flex items-center gap-4">
                        ...
                        <Button size="icon" variant="ghost" className="shrink-0 h-9 w-9 md:opacity-0 md:group-hover:opacity-100 transition-opacity"><Play className="h-4 w-4" /></Button>
                      </CardContent>
                    </Card>
                  </motion.div>
                ))}
                  ...
                  <motion.div key={i} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}>
                    <Card className="group hover:shadow-md hover:border-primary/20 transition-all cursor-pointer">
                      <CardContent className="p-4 flex items-center gap-4">
                        ...
                        <Button size="icon" variant="ghost" className="shrink-0 h-9 w-9 opacity-0 group-hover:opacity-100 transition-opacity"><Download className="h-4 w-4" /></Button>
                      </CardContent>
                    </Card>
                  </motion.div>
                ))}
